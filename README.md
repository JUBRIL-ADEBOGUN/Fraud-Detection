...
*   **Recall:** Captures `92%` of all fraudulent transactions.
*   **False Positive Rate:** `0.094%` (Falsely flags less than one-tenth of one percent of legitimate transactions, ensuring extremely low customer friction/churn).
